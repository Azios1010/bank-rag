...
- Combined records: 100 (seed 25 REVIEWED + new 75 DRAFT)
- Scope distribution: {'collateral_appraisal': 20, 'credit': 20, 'customer_relationship': 20, 'legal_compliance': 20, 'risk_management': 20}
...
- **Change note:** Question category changed from threshold to direct; the question itself and evidence target were retained.
- **Status:** `DRAFT`
...
- **Scope:** `credit`
- **Question:** Khi tính tổng mức phơi nhiễm để áp dụng hạn mức và tuyến phê duyệt, những khoản nghĩa vụ nào phải được tính vào?
- **Expected canonical chunk ID:** `1ad078503e952d4c010471185961e8f00a5580e6ecb80b7b46efff824a9a9f09`
- **Source:** Credit Approval & Exception Policy (`synthetic-credit-approval-v1` / `synthetic-credit-approval-v1.2026-09-01`)
- **Visibility:** `SCOPED`; provenance `synthetic`
- **Locator:** article=APR-EXPOSURE, jsonl_line=1600; heading `Credit Approval & Exception Policy › ## 1. Status and exposure calculation`
- **Question type:** `direct`; **Difficulty:** `MEDIUM`
- **Evidence:** Rule ID: APR-EXPOSURE. Total exposure equals the proposed facility plus existing HHB funded and committed credit obligations plus applicable guarantees and contingent obligations included by HHB policy. The product cap and all approval tiers use this total exposure, not only the new draw. Amounts above VND 5 billion are outside the SME unsecured working-capital product.
...
- **Change note:** Replaced the duplicated UW-DSCR target with APR-EXPOSURE to cover total-exposure calculation and approval limits.
- **Status:** `DRAFT`

### stage13e-038

- **Scope:** `credit`
- **Question:** Khoản cấp tín dụng trên 1 tỷ đồng đến 3 tỷ đồng có thể do cấp nào phê duyệt và phải đáp ứng những điều kiện gì?
- **Expected canonical chunk ID:** `7b94c1d235374306aa2b1ab6ab9da4a9d8335c288ad88515cc4e85463d30c02e`
- **Source:** Credit Approval & Exception Policy (`synthetic-credit-approval-v1` / `synthetic-credit-approval-v1.2026-09-01`)
- **Visibility:** `SCOPED`; provenance `synthetic`
- **Locator:** article=APR-TIER-2, jsonl_line=1602; heading `Credit Approval & Exception Policy › ## 2. Approval authority`
- **Question type:** `threshold`; **Difficulty:** `MEDIUM`
- **Evidence:** Rule ID: APR-TIER-2. Tier 2 Branch Credit Committee may approve total exposure above VND 1 billion and up to VND 3 billion only for Grade A/B, all-standard, no-exception cases. Independent Risk review is required.
...
- **Change note:** Replaced the duplicated APR-TIER-4/two-exception target with the distinct Grade A/B Tier 2 approval rule.
- **Status:** `DRAFT`

### stage13e-039

- **Scope:** `risk_management`
- **Question:** Bộ phận quản lý nợ và cam kết ngoại bảng phải đảm nhiệm những trách nhiệm nào trong việc vận hành hệ thống xếp hạng, phân loại nợ và dự phòng?
- **Expected canonical chunk ID:** `964bf8d08a30cdc684c80f3d672844e92d7cca27879e9cc2b055c3206eeacc42`
...
- **Visibility:** `SHARED`; provenance `real_authoritative`
- **Locator:** article=12, jsonl_line=944; heading `Chương II › Mục 2 QUẢN LÝ NỢ, CAM KẾT NGOẠI BẢNG, TRÍCH LẬP VÀ SỬ DỤNG DỰ PHÒNG RỦI RO`
- **Question type:** `role`; **Difficulty:** `HARD`
- **Evidence:** Điều 12. Quản lý nợ, cam kết ngoại bảng, trích lập và sử dụng dự phòng rủi ro 1. Ngân hàng, tổ chức tín dụng phi ngân hàng phải có bộ phận quản lý nợ, cam kết ngoại bảng (phòng, ban hoặc tương đương) tại trụ sở chính của ngân hàng thương mại, tổ chức tín dụng phi ngân hàng, trụ sở chi nhánh ngân hàng nước ngoài để quản lý việc thực hiện việc phân loại nợ, cam kết ngoại bảng, trích lập và sử dụng dự phòng rủi ro trong toàn hệ thống theo quy định của pháp luật. 2. Trách nhiệm của bộ phận quản lý nợ, cam kết ngoại bảng: a) Xây dựng, trình Tổng giám đốc (Giám đốc) để trình Hội đồng quản trị, Hội đồng thành viên (đối với ngân hàng thương mại, tổ chức tín dụng phi ngân hàng) hoặc trình Tổng giám đốc (Giám đốc) (đối với chi nhánh ngân hàng nước ngoài) phê duyệt áp dụng, ban hành: (i) Hệ thống xếp hạng tín dụng nội bộ, bổ sung, sửa đổi hệ thống xếp hạng tín dụng nội bộ; (ii) Chính sách dự phòng rủi ro, sửa đổi, bổ sung chính sách dự phòng rủi ro; b) Xây dựng, trình Tổng giám đốc (Giám đốc) ban hành các quy định về quản lý, vận hành hệ thống xếp hạng tín dụng nội bộ, việc thu thập, bổ sung số liệu, thông tin khách hàng; c) Quản lý, vận hành hệ thống xếp hạng tín dụng nội bộ; d) Quản lý việc thực hiện việc phân loại nợ, cam kết ngoại bảng, trích lập và sử dụng dự phòng rủi ro trong toàn hệ thống; đ) Tổng hợp, báo cáo, đề xuất Hội đồng xử lý rủi ro các nội dung thuộc thẩm quyền quyết định của Hội đồng xử lý rủi ro theo quy định tại Nghị định về trích lập dự phòng rủi ro; e) Quản lý, theo dõi các đơn vị, cá nhân trong việc thực hiện quy định tại điểm đ khoản 3 Điều 6 Thông tư này; g) Cung cấp thông tin, phối hợp với các đơn vị chức năng tại trụ sở chính trong việc xây dựng trình Tổng giám đốc (Giám đốc) để trình Hội đồng quản trị, Hội đồng thành viên (đối với ngân hàng thương mại, tổ chức tín dụng phi ngân hàng) hoặc trình Tổng giám đốc (Giám đốc) (đối với chi nhánh ngân hàng nước ngoài) ban hành hoặc sửa đổi, bổ sung quy định nội bộ về cấp tín dụng, quản lý nợ của ngân hàng, tổ chức tín dụng phi ngân hàng; h) Thực hiện nhiệm vụ khác theo quy định nội bộ của ngân hàng, tổ chức tín dụng phi ngân hàng.
...
- **Change note:** Replaced the duplicated Article 4 information-collection target with Article 12 responsibilities of the debt and off-balance-sheet management function.
- **Status:** `DRAFT`
...
- **Scope:** `risk_management`
- **Question:** Quy định nội bộ phải đặt ra yêu cầu quản lý như thế nào để bảo đảm tuân thủ các giới hạn và tỷ lệ an toàn do Ngân hàng Nhà nước quy định?
...
- **Change note:** Narrowed the question to the management requirement actually stated by the evidence; it no longer asks the chunk to enumerate ratios.
- **Status:** `DRAFT`
...
- **Scope:** `risk_management`
- **Question:** Khi thẩm định SME, cần xác minh và đánh giá những nhóm thông tin nào về pháp lý, sở hữu, quản lý, ngành nghề và mức độ tập trung?
...
- **Change note:** Removed the unsupported approval-routing workflow phrase and retained the evidence-supported SME information groups.
- **Status:** `DRAFT`
...
- **Scope:** `risk_management`
- **Question:** Với hồ sơ Grade C có đúng một ngoại lệ mềm, hồ sơ phải ghi nhận những nội dung nào về quy tắc bị lệch, bằng chứng, nguyên nhân, biện pháp giảm thiểu và rủi ro còn lại?
...
- **Change note:** Refocused the question from the two-exception/Tier 4 case to ordinary Grade C with exactly one soft exception.
- **Status:** `DRAFT`
...
- **Change note:** Question category changed from consequence to direct; the question and evidence target were retained.
- **Status:** `DRAFT`
...
- **Change note:** Retained the supported question and gold chunk, and expanded the rationale/evidence presentation to cover all five prohibited-conduct paragraphs.
- **Status:** `DRAFT`
...
- **Scope:** `legal_compliance`
- **Question:** Sau khi nhận đủ hồ sơ hợp lệ, thời hạn cấp hoặc từ chối cấp phép đối với tổ chức tín dụng hoặc chi nhánh ngân hàng nước ngoài và đối với văn phòng đại diện nước ngoài khác nhau như thế nào?
...
- **Change note:** Reworded the question to preserve the Article 31 distinction between 180-day and 60-day licensing deadlines.
- **Status:** `DRAFT`
...
- **Scope:** `legal_compliance`
- **Question:** Những thay đổi nào buộc hồ sơ tín dụng phải được phê duyệt lại trước khi tiếp tục xử lý?
- **Expected canonical chunk ID:** `dcaaa7a6994303d7850c83a21693a418aba2420b7928337993e6be84a1842c21`
- **Source:** Credit Approval & Exception Policy (`synthetic-credit-approval-v1` / `synthetic-credit-approval-v1.2026-09-01`)
- **Visibility:** `SCOPED`; provenance `synthetic`
- **Locator:** article=APR-REAPPROVAL, jsonl_line=1610; heading `Credit Approval & Exception Policy › ## 4. Approval controls, expiry, and re-approval`
- **Question type:** `consequence`; **Difficulty:** `HARD`
- **Evidence:** Rule ID: APR-REAPPROVAL. Re-approval is required when requested amount or total exposure rises by more than 10%; purpose or tenor changes; ownership or control changes; a new overdue or CIC adverse event occurs; DSCR falls by more than 10%; a material financial restatement occurs; or approval expires. Renewal under [[PROD-RENEWAL]] is a new review and follows this rule.
...
- **Change note:** Replaced the duplicated maker-checker target with the distinct re-approval triggers rule.
- **Status:** `DRAFT`
...
- **Change note:** Removed the unsupported collateral-security phrase from the rationale; question and evidence target were retained.
- **Status:** `DRAFT`
...
- **Change note:** Question category changed from customer-facing to role; the question and evidence target were retained.
- **Status:** `DRAFT`
...
- **Scope:** `customer_relationship`
- **Question:** Sản phẩm vốn lưu động SME không bảo đảm cho phép những cấu trúc trả nợ nào và cấm hình thức nào?
- **Expected canonical chunk ID:** `40cc0096b54df95d426fdf7c249200893e39320e287bce97205a7e751213b465`
- **Source:** SME Unsecured Working Capital Product Policy (`synthetic-sme-working-capital-v1` / `synthetic-sme-working-capital-v1.2026-09-01`)
- **Visibility:** `SCOPED`; provenance `synthetic`
- **Locator:** article=PROD-REPAYMENT, jsonl_line=1582; heading `SME Unsecured Working Capital Product Policy › ## 3. Standard eligibility and product structure`
- **Question type:** `distinction`; **Difficulty:** `MEDIUM`
- **Evidence:** Rule ID: PROD-REPAYMENT. Permitted structures are: (a) an amortizing term facility with monthly interest and at least quarterly principal; or (b) a revolving line with monthly interest and a clean-down to zero for 30 consecutive days within each 12-month period. Bullet repayment is prohibited.
...
- **Change note:** Replaced the duplicated required-document/hold-refer target with the distinct permitted repayment-structures rule.
- **Status:** `DRAFT`
...
- **Scope:** `collateral_appraisal`
- **Question:** Thế chấp quyền sử dụng đất có thuộc trường hợp phải đăng ký biện pháp bảo đảm không?
...
- **Change note:** Narrowed the plural question to the single land-use-right mortgage point contained in the selected chunk.
- **Status:** `DRAFT`
